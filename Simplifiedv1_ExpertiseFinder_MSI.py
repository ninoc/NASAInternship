...
def step6_expertiseFinder(paperSearchDf):
    ...
    paperSearchDf1, cleanDict1 = TAinFA_TAinAFFS(paperSearchDf, cleanDict)
    paperSearchDf2, cleanDict2 = TAisFA(paperSearchDf1, cleanDict1)
    paperSearchDf3, cleanDict3 = TIinAFFS(paperSearchDf2, cleanDict2)
    paperSearchDf4, cleanDict4 = JNinBIB(paperSearchDf3, cleanDict3)
    
    dirtyDataDf = paperSearchDf4
    cleanDataDf = pd.DataFrame(cleanDict4)
...
def step6_expertiseFinderNameInst(paperSearchDf):
    ...
    paperSearchDf, cleanDict = TAinFA(paperSearchDf, cleanDf)
    paperSearchDf, cleanDict = TIinAFFS(paperSearchDf, cleanDf)
    paperSearchDf, cleanDict = JNinBIB(paperSearchDf, cleanDict)
